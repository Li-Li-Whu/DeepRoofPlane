...
def parse_config():
    ...
    parser.add_argument('--data_path', type=str, default='/media/adminn/s2/lqq/roofsegmentation/dataset', help='dataset path')
    parser.add_argument('--dataset', type=str, default='RoofN3d', help='Roofpc3d/RoofN3d')
    parser.add_argument('--cfg_file', type=str, default='./roofseg3.yaml', help='model config for training')
    parser.add_argument('--batch_size', type=int, default=16, help='batch size for training')
    parser.add_argument('--gpu', type=str, default='0', help='gpu for training')
    parser.add_argument('--extra_tag', type=str, default='train_roofN3d1.7k_xyz', help='extra tag for this experiment')
...
def main():
    ...
    train_loader = build_dataloader(args.data_path, args.dataset, args.batch_size, cfg.DATA, training=True, logger=logger)

    net = RoofSeg(cfg.MODEL)
    net.cuda()
